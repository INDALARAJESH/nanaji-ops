...
output "api_gateway_stage_id" {
  ...
  value       = module.api_gateway_lambda_integration.stage_id
}

output "api_gateway_stage_arn" {
  description = "stage arn of api gateway"
  value       = module.api_gateway_lambda_integration.stage_arn
}

output "api_gateway_stage_name" {
  description = "stage name of api gateway"
  value       = module.api_gateway_lambda_integration.stage_name
}
